...
from core.models import ReportFeedbackRecord, \
        ...
        ReportFeedbackRecordAuthResultsSpf, Industry, Regions, Domains
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            ...
            meta_data_report = ReportFeedbackMetaData.objects.create(
                ...
                sp=file_json['feedback']['policy_published'][
                    'sp'] if 'sp' in file_json['feedback'][
                        'policy_published'] else None,
